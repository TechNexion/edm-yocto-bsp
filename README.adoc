= TechNexion Yocto 2.0 jethro 4.1.15 Next BSP
...
link:https://github.com/TechNexion/meta-edm-bsp-release/raw/jethro_4.1.15-1.1.0_GA/Documents/PreBuilt_OS_Image_Installation_Guide_v3.4.pdf[PreBuilt_OS_Image_Installation_Guide.pdf]